...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-brand-black/60 backdrop-blur-sm">
      <div className="bg-brand-white w-full max-w-2xl rounded-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-8 font-sans text-brand-gray leading-relaxed">
          {children}
        </div>
      </div>
    </div>
